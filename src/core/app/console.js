...
// 控制台输出：TTY（真实控制台）直接写字符串，Node 走 WriteConsoleW(UTF-16)，永远不乱码；
// 非 TTY（IDE 内置终端/管道捕获）按系统代码页（中文环境 936=GBK）输出字节，
// 因为 IDE 终端直接读子进程字节流并继承系统 ACP 解码，不认 chcp 65001。
// 若输出 UTF-8 而解码端是 GBK → 锟斤拷；故必须与系统 ACP 对齐。
